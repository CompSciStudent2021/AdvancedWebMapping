...
if socket.gethostname() == 'LAPTOP-DBDN28NQ':
...
if DEPLOY_SECURE:
    ...
    ALLOWED_HOSTS = ['*.c21730391.xyz', 'c21730391.xyz', 'localhost', '127.0.0.1']
    ...
    CSRF_TRUSTED_ORIGINS = ['https://c21730391.xyz']
else:
...
os.environ['PATH'] += r";C:\Users\Ryanf\miniconda3\envs\awm_env\Library\bin"
os.environ['GDAL_DATA'] = r"C:\Users\Ryanf\miniconda3\envs\awm_env\Library\share\gdal"
